...
instance ?= defaults
test_instances = tests/defaults.yml tests/suspended-cronjobs.yml tests/with-org-id.yml tests/external-secret.yml tests/with-rules.yml tests/test-mode.yml
